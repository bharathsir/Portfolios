...
?>
		...
		<form action="editdetails2.php" method="post">
		<table>
		<tr>
		<th>Fullname:</th>
		...
		<tr>
		<th>Age:</th>
		<td><input type="text" name="age" value="<?php echo $output[24]?>" /></td>
		</tr>
		<tr>
		<td><br /></td>
		</tr>
		...
		<tr>
		<th>Martial:</th>
		<td><input type="text" name="martial" value="<?php echo $output[25]?>" /></td>
		</tr>
		...
		<tr>
		<td><a href="adminindex2.php?page=1"><button  class="btn btn-danger  ">Back</button></td>
		<td><a href="editdetails2.php"><button  class="btn btn-primary  ">Update</button></td>
		</a>
		</tr>
