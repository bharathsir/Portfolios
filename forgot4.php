...
?>
<form  action="forgot1.1.php" onsubmit="return myfun()" method="post">
<table>
<tr>
...
<tr>
<td><input type="email2" class="box"   readonly disabled value="<?php echo  $output[2] ?>" name="fname" id="t0"/></td>
<span id="res"></span>


<tr>
	<th>Create a Password <em>*</em></th>
...
<tr>
<td><input type="password" class="box"  name="pass"  id="t2" /></td>
