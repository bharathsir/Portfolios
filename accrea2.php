...
<h6 class="text"><i class="far fa-check-circle icon1"></i>You Regsitration is Successfully Done!</h6>

<h6 class="text"><a href="user.html" class="text-success">Click here</a> to login  </h6>
