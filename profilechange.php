...
$select="select *from registration where no='$id'";
...
<h4>Change Photo</h4>
<tr><th>Profile Photo</th><td><div align="center"><h5>Existing Photo</h5><img src="images/<?php echo $output[6]; ?>" height="250"  width="280"   /><br /><h5><?php echo $output[1]; ?></h5>
<input type="file" name="proimage" /><button type="submit" class="btn btn-info button " >  Upload</button></td></tr>
