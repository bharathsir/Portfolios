...
<nav class="navbar navbar-expand-lg   bg-secondary nav1">
  ...
  <h6 class="font-weight-bold text-white admin "><i class="fas fa-user"></i><?php echo $_SESSION['email']; ?></h6>
  
      <a href="logout.php"><button type="button" class="btn btn-primary mr-2">LOGOUT</button></a>
...
<tr><th>ID</th><td><?php echo $output['no']; ?></td></tr>
<tr><th>Fullname</th><td><?php echo $output[1]; ?></td></tr>
<tr><th>Email</th><td><?php echo $output[2]; ?></td></tr>
<tr><th>Password</th><td><?php echo md5($output[3]); ?></td></tr>
<tr><th>Mobile</th><td><?php echo md5($output[4]); ?></td></tr>
<tr><th>Gender</th><td><?php echo $output[5]; ?></td></tr>
<tr><td colspan=2 ><a href="show.php" class="btn btn-primary text-white">GO BACK</a></td></tr>
</table>
