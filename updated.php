...
?>
	<a href="delete1.php?id=<?php echo $output['no']; ?>" onclick="return confirm('Do You want to delete Account?')"><button type="button" class="btn btn-danger">Delete Account</button></a>

<br />
<table class="table table-bordered w-100 mx-auto table-striped">
<h2>Your Given details</h2>
<tr><th>Reg.no</th><td><?php echo $output['no']; ?>   <em >(*Pls Note the Registration no)</em></td></tr>
<tr><th>Fullname</th><td><?php echo $output[1]; ?></td></tr>
...
<h5>Your Details has been updated <a href="adaccount1.php">Show</a></h5>
