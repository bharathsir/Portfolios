...
<h6 class="text"><i class="far fa-smile text-success icon1"></i>You have successfully logged out of Digilocker</h6>
<h6 class="text">Thank you for using Digilocker</h6>
<h6 class="text"><a href="user.html" class="text-success">Click here</a> to logon to Digilocker</h6>
