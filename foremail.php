...
function myfun()
	{
	var pass1=document.getElementById('t1').value;
	
	
	if(pass1=="")
	{
	document.getElementById('res1').innerHTML="Enter Your  Mobile";
...
<form action="foremail2.php" onsubmit="return myfun()" method="post">
<table>
<tr>
<button type="button" class="btn btn-info user " >User</button></a>
</tr>
<tr>
	<th> Enter Mobile <em>*</em></th>


</tr>
<tr>
<td><input type="password" class="box"   name="mobile"  id="t1"/></td>
<span id="res1"></span>
...
<td><input type="submit" value="Next" class="btn btn-danger text-white" onclick="myfun()"/></td>
<td><h6><a href="forgot2.php" >Forgot Password? </h6></a></td></tr>
